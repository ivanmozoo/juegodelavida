...
# Constantes
ANCHO = int(input("\nIntroduce el ancho de la cuadrícula: ")) # Ancho de la cuadrícula
ALTO = int(input("\nIntroduce el alto de la cuadrícula: ")) # Alto de la cuadrícula

VIVO = str(input("\nIntroduce el carácter que representará las celdas vivas: "))# Carácter para la celda viva
